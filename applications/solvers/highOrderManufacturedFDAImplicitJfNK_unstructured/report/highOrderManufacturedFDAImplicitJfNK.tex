...
figures can be regenerated by running \code{plot\_convergence.m} in this report
directory. Each plot legend reports the fitted orders over $N=10$--$100$ and
$N=70$--$100$ plus the accumulated runtime and peak-RSS cost of the
corresponding mesh sweep. Missing figure boxes indicate plots that have not yet
been generated from the latest data.
