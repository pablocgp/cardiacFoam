...
namespace
{
    ...
    {
        reactionRates(VmNew, u1, u2, u3, du1dt, du2dt, du3dt);
    }
...
int main(int argc, char* argv[])
{
    ...
    if (writeNonlinearResiduals)
    {
        ...
        nonlinearResidualFilePtr()
            ...
            << "newtonResidual Vm_relL2 u1_relL2 u2_relL2 Iion_relL2 "
    ...
    while (runTime.value() < runTime.endTime().value() - SMALL)
    {
        ...
        if (useJFNK)
        {
            ...
            )
            {
                ...
                const scalar u1ResidualInitial =
                    relativeL2Difference(u1Guess.primitiveField(), u1Previous);
                const scalar u2ResidualInitial =
